        ...
        for iface in ifaces:
            ...
            try:
                ...
                for network in networks:
                    #BSSID_Name = network.dot11Bssid
                    quality = network.wlanSignalQuality
                    SSID_Name = network.dot11Ssid.SSID[:network.dot11Ssid.SSIDLength].decode()
                    ...
                    # Calculate distance based on FSPL formula
                    distance = calculateDistance(dBm, 2412)
                    
                    
                    #if "Law" in SSID_Name:
                    print("SSID: {:>20}, dBm: {}, quality: {:2d}%, distance(m): {}".format("test",
                        dBm, quality, distance))
            finally:
